# This ARM Template will deploy a simple 3-tier architecture in Azure
# We can pick the ARM template from the below github repo and make changes as
# per the use case.
# https://raw.githubusercontent.com/MicrosoftDocs/mslearn-n-tier-architecture/master/Deployment/azuredeploy.json
